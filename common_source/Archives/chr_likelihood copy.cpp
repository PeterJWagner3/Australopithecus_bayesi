...
double LikelihoodClass::PoissonProbablity(bool change, NODE *l)	{
	if (!change)	{
		return Poisson(pÆ[chr_number],l->bl,0)
			+((paths_back(1,*data->GetNStates(chr_number))/(pow(GetNStates(chr_number)-1,1)))*Poisson(pÆ[chr_number],l->bl,1)
			+((paths_back(2,*data->GetNStates(chr_number))/(pow(GetNStates(chr_number)-1,2)))*Poisson(pÆ[chr_number],l->bl,2)
			+((paths_back(3,*data->GetNStates(chr_number))/(pow(GetNStates(chr_number)-1,3)))*Poisson(pÆ[chr_number],l->bl,3)
			+((paths_back(4,*data->GetNStates(chr_number))/(pow(GetNStates(chr_number)-1,4)))*Poisson(pÆ[chr_number],l->bl,4)
			+((paths_back(5,*data->GetNStates(chr_number))/(pow(GetNStates(chr_number)-1,5)))*Poisson(pÆ[chr_number],l->bl,5);
		}
	else	{
		return Poisson(pÆ[chr_number],l->bl,0)
			+((pow(GetNStates(chr_number)-1,1))+(paths_back(1,*data->GetNStates(chr_number)))/(pow(GetNStates(chr_number)-1,1)))*Poisson(pÆ[chr_number],l->bl,1)
			+((pow(GetNStates(chr_number)-1,2))+(paths_back(2,*data->GetNStates(chr_number)))/(pow(GetNStates(chr_number)-1,2)))*Poisson(pÆ[chr_number],l->bl,2)
			+((pow(GetNStates(chr_number)-1,3))+(paths_back(3,*data->GetNStates(chr_number)))/(pow(GetNStates(chr_number)-1,3)))*Poisson(pÆ[chr_number],l->bl,3)
			+((pow(GetNStates(chr_number)-1,4))+(paths_back(4,*data->GetNStates(chr_number)))/(pow(GetNStates(chr_number)-1,4)))*Poisson(pÆ[chr_number],l->bl,4)
			+((pow(GetNStates(chr_number)-1,5))+(paths_back(5,*data->GetNStates(chr_number)))/(pow(GetNStates(chr_number)-1,5)))*Poisson(pÆ[chr_number],l->bl,5);
		}
	}
